...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border border-blue-900 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-blue-900 dark:focus:ring-zinc-300",
  {
    variants: {
      variant: {
        default:

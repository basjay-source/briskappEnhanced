  ...
  return (
    <div className={`space-y-6 ${isMobile ? 'p-4' : 'p-6'}`}>
      <div className={`flex ${isMobile ? 'flex-col space-y-4' : 'items-center justify-between'}`}>
        <div>
          <h1 className={`font-bold text-[#001f3f] ${isMobile ? 'text-2xl' : 'text-3xl'}`}>
            VAT Management
          </h1>
          <p className="text-[#001f3f] mt-2">Comprehensive VAT returns, schemes, and compliance management</p>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <CardHeader className="pb-3">
                  <div className={`flex ${isMobile ? 'flex-col space-y-3' : 'items-center justify-between'}`}>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-lg text-[#001f3f]">VAT Return - {vatReturn.period}</CardTitle>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle className="text-lg text-[#001f3f]">{scheme.name}</CardTitle>
                    </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-lg text-[#001f3f]">VAT Liability Trend</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#001f3f] mb-4">Track VAT liability over time</p>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-lg text-[#001f3f]">VAT Rate Analysis</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#001f3f] mb-4">Analyze VAT rates across transactions</p>
                <Button className="w-full bg-brisk-primary hover:bg-brisk-primary-600">
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-lg text-[#001f3f]">Submission History</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#001f3f] mb-4">Historical VAT return submissions</p>
                <Button className="w-full bg-brisk-primary hover:bg-brisk-primary-600">
        ...
        <TabsContent value="compliance" className="space-y-4 mt-6">
          ...
          <div className="grid gap-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg text-[#001f3f]">MTD Compliance Status</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg text-[#001f3f]">Audit Trail</CardTitle>

...
const AdminModule = () => {
  ...
  const renderLeftRail = () => (
    <div className="w-64 bg-white border-r-2 border-[#001f3f] flex flex-col">
      <div className="p-6 border-b-2 border-[#001f3f]">
        <h2 className="text-lg font-semibold text-[#001f3f]">Admin Control</h2>
        <p className="text-sm text-[#001f3f]">Multi-tenant management</p>
      </div>
        ...
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="p-4 border-2 border-[#001f3f] rounded-[2px]">
              <h4 className="font-semibold text-[#001f3f] mb-2">Revenue Sources</h4>
            ...
            <div className="p-4 border-2 border-[#001f3f] rounded-[2px]">
              <h4 className="font-semibold text-[#001f3f] mb-2">Growth Metrics</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span>New MRR</span>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-[#001f3f]">Admin Overview</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-[#001f3f]">System Health</CardTitle>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              {approvalRequests.map((request) => (
                <div key={request.id} className="p-4 border-2 border-[#001f3f] rounded-[2px]">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-semibold text-[#001f3f]">{request.type}</h4>
  ...
  const renderCatalogPricing = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Catalog & Pricing</h1>
        <div className="flex space-x-3">
          ...
          drillDownData={{
            ...
            content: (
              <div className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="p-4 border-2 border-[#001f3f] rounded-[2px]">
                    <h4 className="font-semibold text-[#001f3f] mb-2">Plan Distribution</h4>
                    {plans.map(plan => (
                  ...
                  <div className="p-4 border-2 border-[#001f3f] rounded-[2px]">
                    <h4 className="font-semibold text-[#001f3f] mb-2">Revenue by Plan</h4>
                    {plans.map(plan => (
                      <div key={plan.id} className="flex justify-between py-1">
                        <span>{plan.name}</span>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-[#001f3f]">Plan Catalog</CardTitle>
          <CardDescription>Manage pricing plans and versions</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {plans.map((plan) => (
              <div key={plan.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <h3 className="font-semibold text-[#001f3f]">{plan.name}</h3>
  ...
  const renderPromotions = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Promotions & Coupons</h1>
        <div className="flex space-x-3">
          <Button variant="outline">
            <Download className="h-4 w-4 mr-2" />
            Export Performance
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-[#001f3f]">Promotion Management</CardTitle>
          <CardDescription>Manage promotional campaigns and coupon codes</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {promotions.map((promo) => (
              <div key={promo.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <h3 className="font-semibold text-[#001f3f]">{promo.name}</h3>
  ...
  const renderExperiments = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Experiments & Feature Flags</h1>
        <div className="flex space-x-3">
          <Button variant="outline">
            <Download className="h-4 w-4 mr-2" />
            Export Results
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-[#001f3f]">Experiment Management</CardTitle>
          <CardDescription>A/B tests and feature flag management</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {experiments.map((exp) => (
              <div key={exp.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <h3 className="font-semibold text-[#001f3f]">{exp.name}</h3>
  ...
  const renderTenants = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Tenants & Subscriptions</h1>
        <div className="flex space-x-3">
          <Button variant="outline">
            <Download className="h-4 w-4 mr-2" />
            Export Tenants
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-[#001f3f]">Tenant Management</CardTitle>
          <CardDescription>Manage customer subscriptions and entitlements</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {tenants.map((tenant) => (
              <div key={tenant.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <h3 className="font-semibold text-[#001f3f]">{tenant.name}</h3>
  ...
  const renderSettings = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Admin Settings</h1>
        <Button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-[#001f3f]">RBAC Configuration</CardTitle>
            <CardDescription>Role-based access control settings</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {adminPersonas.slice(0, 4).map((persona) => (
                <div key={persona.id} className="flex items-center justify-between p-3 border-2 border-[#001f3f] rounded-[2px]">
                  <div>
                    <h4 className="font-semibold text-[#001f3f]">{persona.name}</h4>
                    <p className="text-sm text-[#001f3f]">{persona.description}</p>
                  </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-[#001f3f]">System Configuration</CardTitle>
  ...
  const renderInvoicesDunning = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Invoices & Dunning</h1>
        <div className="flex space-x-3">
          <Button variant="outline">
            <Download className="h-4 w-4 mr-2" />
            Export Invoices
      ...
      <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-[#001f3f]">Invoice Management</CardTitle>
              <CardDescription>Manage customer invoices and billing</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {invoices.map((invoice) => (
                  <div key={invoice.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                    <div className="flex-1">
                      <div className="flex items-center gap-3">
                        <h3 className="font-semibold text-[#001f3f]">{invoice.id}</h3>
                        <Badge variant={
  ...
  const renderPartnersReferrals = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Partners & Referrals</h1>
        <div className="flex space-x-3">
          <Button variant="outline">
            <Download className="h-4 w-4 mr-2" />
            Export Data
      ...
      <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-[#001f3f]">Partner Management</CardTitle>
              <CardDescription>Manage channel partners and commission structures</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {partners.map((partner) => (
                  <div key={partner.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                    <div className="flex-1">
                      <div className="flex items-center gap-3">
                        <h3 className="font-semibold text-[#001f3f]">{partner.name}</h3>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-[#001f3f]">Referral Management</CardTitle>
              <CardDescription>Track referral program performance</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {referrals.map((referral) => (
                  <div key={referral.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                    <div className="flex-1">
                      <div className="flex items-center gap-3">
                        <h3 className="font-semibold text-[#001f3f]">{referral.referee}</h3>
  ...
  const renderGrowthJourneys = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Growth Journeys</h1>
        <div className="flex space-x-3">
          <Button variant="outline">
            <Download className="h-4 w-4 mr-2" />
            Export Analytics
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-[#001f3f]">Journey Management</CardTitle>
          <CardDescription>Automated growth and engagement campaigns</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {growthJourneys.map((journey) => (
              <div key={journey.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <h3 className="font-semibold text-[#001f3f]">{journey.name}</h3>
  ...
  const renderAuditLog = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Audit Log</h1>
        <div className="flex space-x-3">
          <Button variant="outline">
            <Download className="h-4 w-4 mr-2" />
            Export Audit Trail
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-[#001f3f]">System Audit Trail</CardTitle>
          <CardDescription>Tamper-evident log of all administrative actions</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {auditLogs.map((log) => (
              <div key={log.id} className="flex items-center justify-between p-4 border-2 border-[#001f3f] rounded-[2px]">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <h3 className="font-semibold text-[#001f3f]">{log.action}</h3>
  ...
  const renderTemplates = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-[#001f3f]">Templates & Branding</h1>
        <Button>
          <Plus className="h-4 w-4 mr-2" />
          Create Template
        </Button>
    ...
    <ResponsiveLayout>
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {isMobile && (
            <div className="p-4 bg-white border-b-2 border-[#001f3f]">

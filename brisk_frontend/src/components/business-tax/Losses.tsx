    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <button className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">Optimize Relief</button>
          <button className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">Generate Statement</button>
        </div>
      </div>
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8">
          {[{ id: 'brought-forward', label: 'Brought-forward' }, { id: 'in-year', label: 'In-year' }, { id: 'carry-back-forward', label: 'Carry-back/Forward' }, { id: 'streaming', label: 'Streaming' }].map((tab) => (
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold mb-4">Losses Management</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-sm font-medium text-gray-500">Utilized</h3>
            <p className="text-2xl font-bold text-green-600">£12,000</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-sm font-medium text-gray-500">C/F Losses</h3>
            <p className="text-2xl font-bold text-orange-600">£0</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-sm font-medium text-gray-500">Tax Saved</h3>
            <p className="text-2xl font-bold text-blue-600">£2,280</p>
          </div>
        </div>
      </div>
    </div>

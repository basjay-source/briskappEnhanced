    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <button className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">Add Disposal</button>
          <button className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">Compute Gains</button>
        </div>
      </div>
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8">
          {[{ id: 'disposals', label: 'Disposals' }, { id: 'indexation', label: 'Indexation (legacy)' }, { id: 'rollover', label: 'Rollover/Sch 7AC' }, { id: 'substantial-shareholding', label: 'Substantial Shareholding' }].map((tab) => (
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold mb-4">Chargeable Gains Computation</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-sm font-medium text-gray-500">Reliefs Applied</h3>
            <p className="text-2xl font-bold text-blue-600">£0</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-sm font-medium text-gray-500">Chargeable Gains</h3>
            <p className="text-2xl font-bold text-orange-600">£5,000</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-sm font-medium text-gray-500">CT on Gains</h3>

                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Must be available for at least {propertyData.fhl_tests?.days_available_required || 210} days
                    </p>
                  </div>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Must be let for at least {propertyData.fhl_tests?.days_let_required || 105} days
                    </p>
                  </div>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Must not exceed {propertyData.fhl_tests?.long_lettings_limit || 155} days to same person
                    </p>
                  </div>
                </div>
              </div>
